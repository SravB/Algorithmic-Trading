...
for i in range(0,1):
    ...
    print("Expected Cash: " + str(initC * StockPrice / initP))
    print("Performance: " + str(100 * Cash * initP / (StockPrice * initC)) + "%")
    print("")
    
print("Number of Correct Predictions: " + str(counterR) + " / " + str(counterT))
print("Accuracy: " + str(100*counterR/counterT) + "%")
print("Average Yield: " + str(avg))
print("Average Performance: " + str(100 * pavg) + "%")
print("")
